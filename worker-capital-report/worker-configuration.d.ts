/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc` (hash: 4cb497025625d4ded6ae214e182d95fe)
// Runtime types generated with workerd@1.20260907.1 2026-09-07 nodejs_compat
interface __BaseEnv_Env {
	PUBLIC_ORIGIN: "*";
	NOTIFICATIONS_ACTIVE_AFTER: "2026-09-08T00:00:00Z";
	SEC_USER_AGENT: string;
	ADMIN_TOKEN: string;
	DISCORD_WEBHOOK_URL: string;
	ISSUER_POLLER: DurableObjectNamespace<import("./src/index").IssuerPoller>;
	REPORT_NOTIFIER: DurableObjectNamespace<import("./src/index").ReportNotifier>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "IssuerPoller" | "ReportNotifier";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_ORIGIN" | "NOTIFICATIONS_ACTIVE_AFTER" | "SEC_USER_AGENT" | "ADMIN_TOKEN" | "DISCORD_WEBHOOK_URL">> {}
}
