/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc` (hash: 14551d350ca6dce20b167908ec845555)
// Runtime types generated with workerd@1.20260907.1 2026-09-07 nodejs_compat
interface __BaseEnv_Env {
	PUBLIC_ORIGIN: "*";
	SEC_USER_AGENT: string;
	ADMIN_TOKEN: string;
	STREAMLIT_ACK_TOKEN: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_ORIGIN" | "SEC_USER_AGENT" | "ADMIN_TOKEN" | "STREAMLIT_ACK_TOKEN" | "DISCORD_WEBHOOK_URL">> {}
}
